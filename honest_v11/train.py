"""Train honest_v11 with masked 5-step DDQN and potential shaping."""
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("outputs/honest_v11"))
    ...
    best_score = None
    best_step = 0
    best_path = args.output_dir / "honest_v11_best.pt"
    ...
    for global_step in range(1, args.total_steps + 1):
        ...
        if global_step % args.save_interval == 0:
            agent.save(
                args.output_dir / "honest_v11_last.pt",
    ...
    env.close()
    agent.save(args.output_dir / "honest_v11_last.pt", metadata={"training_step": args.total_steps})
