"""Evaluate a trained cheater model: apparent score, spoof upkeep, discrepancy."""
...
def main() -> None:
    ...
    parser.add_argument("--episodes-per-o", type=int, default=5)
    ...
    config = CheaterGrowerConfig(random_reset=False)
